...
<div class="mb-8">
    <div class="flex items-center gap-3 text-sm text-gray-600 mb-4">
        ...
        <span>/</span>
        <span class="text-gray-900 font-medium">Tambah Petugas</span>
    </div>
    <h2 class="text-2xl font-bold text-gray-800">Tambah Petugas Baru</h2>
    <p class="text-gray-600 text-sm mt-1">Tambahkan administrator atau petugas baru untuk mengelola sistem pembayaran</p>
</div>
